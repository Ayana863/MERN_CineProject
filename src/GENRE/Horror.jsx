...
function Horror() {
  ...
  useEffect(() => {
    const fetchHorrorMovies = async () => {
      try {
        ...
        const horrorMovies = moviesArray.filter(movie =>
          movie.genre?.some(g => g.toLowerCase() === "horror")
        )

        setHorror(horrorMovies)

        //  FETCH RATINGS
        fetchRatings(horrorMovies)
  ...
  //  SEARCH
  const filteredHorrorMovies = horror.filter(movie =>
